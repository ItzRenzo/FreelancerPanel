...
public class PendingRequestController {
    ...
    public void loadRequestData() {
        ...
        // Updated query to filter for requests with status 'Requested'
        String query = """
            ...
            WHERE r.user_id = ? AND r.request_status = ?  -- Added condition for 'Requested' status
            """;
        ...
        try (Connection connection = DatabaseHandler.getConnection();
            ...
            preparedStatement.setString(2, "Requested");  // Filter for 'Requested' status
    ...
    public void EditClicked(MouseEvent event) {
        try {
            ...
            idController.setPendingRequestController(this); // Pass reference for further actions
    ...
    public void NewClicked(MouseEvent event) {
        try {
            ...
            newRequestController.setPendingRequestController(this);
